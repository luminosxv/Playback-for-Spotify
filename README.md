...
2. Create a new app
3. Set Redirect URI to your config page URL (e.g. `https://yourusername.github.io/playback_config/`)
...
3. Update the Redirect URI in your Spotify app to match your GitHub Pages URL
